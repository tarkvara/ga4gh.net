namespace GA4GH.Client {
	/// <summary>******************  /callsets  *********************
	/// This request maps to the body of `POST /callsets/search` as JSON.</summary>
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "8.34.6331.29178")]
	public class SearchCallSetsRequest : System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// <summary>Only return call sets with this name (case-sensitive, exact match).</summary>
		...
		/// <summary>Return only call sets generated from the provided Biosample ID.</summary>
		...
		public static SearchCallSetsRequest FromJson(string data)
		{
			return Newtonsoft.Json.JsonConvert.DeserializeObject<SearchCallSetsRequest>(data);
		}
