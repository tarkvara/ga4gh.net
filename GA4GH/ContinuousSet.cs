namespace GA4GH.Client {
	/// <summary>A set of Continous messages. Continuous values can be sent
	...
	/// or to skip NaN values.</summary>
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "8.34.6331.29178")]
	public class ContinuousSet : System.ComponentModel.INotifyPropertyChanged
	{
		private string _id;
		...
		public static ContinuousSet FromJson(string data)
		{
			return Newtonsoft.Json.JsonConvert.DeserializeObject<ContinuousSet>(data);
		}
