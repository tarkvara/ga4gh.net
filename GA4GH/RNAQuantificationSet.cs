namespace GA4GH.Client {
	/// <summary>A collection of associated RNAQuantifications.  Typically this will be all
	...
	public class RNAQuantificationSet : System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// <summary>The RNA quantification set ID.</summary>
		...
		/// <summary>The ID of the dataset this RNA Quantification set belongs to.</summary>
		...
		/// <summary>The RNA quantification set name.</summary>
		...
		/// <summary>A map of additional information about the Quantification Set.</summary>
		...
		public static RNAQuantificationSet FromJson(string data)
		{
			return Newtonsoft.Json.JsonConvert.DeserializeObject<RNAQuantificationSet>(data);
		}
