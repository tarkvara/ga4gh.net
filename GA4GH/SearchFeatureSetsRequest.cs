namespace GA4GH.Client {
	/// <summary>* This request maps to the body of `POST /featuresets/search` as JSON.</summary>
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "8.9.6275.22295")]
	public class SearchFeatureSetsRequest : System.ComponentModel.INotifyPropertyChanged
	{
		...
		public static SearchFeatureSetsRequest FromJson(string data)
		{
			return Newtonsoft.Json.JsonConvert.DeserializeObject<SearchFeatureSetsRequest>(data);
		}
