namespace GA4GH.Client {
	/// <summary>This request maps to the body of `POST /datasets/search` as JSON.</summary>
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "8.34.6331.29178")]
	public class SearchDatasetsRequest : System.ComponentModel.INotifyPropertyChanged
	{
		...
		public static SearchDatasetsRequest FromJson(string data)
		{
			return Newtonsoft.Json.JsonConvert.DeserializeObject<SearchDatasetsRequest>(data);
		}
