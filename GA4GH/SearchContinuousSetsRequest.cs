namespace GA4GH.Client {
	/// <summary>* This request maps to the body of `POST /continuoussets/search` as JSON.</summary>
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "8.34.6331.29178")]
	public class SearchContinuousSetsRequest : System.ComponentModel.INotifyPropertyChanged
	{
		...
		public static SearchContinuousSetsRequest FromJson(string data)
		{
			return Newtonsoft.Json.JsonConvert.DeserializeObject<SearchContinuousSetsRequest>(data);
		}
