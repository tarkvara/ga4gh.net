namespace GA4GH.Client {
	/// <summary>******************  /variantsets  *********************
	/// This request maps to the body of `POST /variantsets/search` as JSON.</summary>
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "8.9.6275.22295")]
	public class SearchVariantSetsRequest : System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// <summary>The continuation token, which is used to page through large result sets. To
		...
		public static SearchVariantSetsRequest FromJson(string data)
		{
			return Newtonsoft.Json.JsonConvert.DeserializeObject<SearchVariantSetsRequest>(data);
		}
